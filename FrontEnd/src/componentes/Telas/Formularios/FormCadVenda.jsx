...
import {buscarTodosOperadores} from "../../../servicos/operadorService";
...
export default function FormCadVenda(props) {
    ...
    useEffect(() => {
        ...
        buscarTodosOperadores(token).then((listaOperadores) => {
    ...
    return (
        <Form noValidate validated={validado} onSubmit={manipulaSubmissao}>
            ...
            <Row>
                <Form.Group as={Col} md="12" controlId="valorTotalTributos">
                    ...
                    <BarraBusca campoBusca={"nome"}
                        campoChave={"cpf"}
                        dados={operadores}
                        funcaoSelecao={(operador) =>{
                            setOperadorSelecionado(operador);
                            setVenda({...venda, operador: operador});
                        }}
            ...
            <Row>
                {
                    //Seção resposável por permitir que maquinarios sejam selecionados para a venda
                    //Demonstração de relacionamento muitos para muitos
                }
                <Container className="m-3 border">
                    <Row className="m-3">
                        <Col md={2}>
                            <Form.Label>Selecione um maquinario</Form.Label>
                        </Col>
                        <Col>
                            <CaixaSelecao enderecoFonteDados={"http://localhost:4000/maquinario"}
                                campoChave={"codigo"}
                                ...
                                localLista={'listaMaquinarios'} 
                                tokenAcesso={contextoUsuario.usuarioLogado.token}/>
                        </Col>
                    </Row>
                    <Row>
                        {
                            //Seção ficará responsável por detalhar o maquinario selecionado
                        }
                        <Col md={10}>
                            <Row>
                                <Col md={1}>
                                ...
                                <Col md={4}>
                                    <Form.Group>
                                        <Form.Label>Descrição do Maquinario:</Form.Label>
                                        <Form.Control 
                                        type="text" 
                                        disabled 
                    ...
                    <Row className="mt-3">
                        <p><strong>Lista de maquinarios escolhidos</strong></p>
                        <TabelaItensVenda
